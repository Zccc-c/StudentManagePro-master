...
<head>
    ...
    <script src="<%= basePath%>js/employee/add.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/employee/update.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/employee/examine.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/reRange.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/flip.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/employee/del.js" type="text/javascript"></script>
...
<%--                    <td class="col1"><input type="checkbox" name="item" /></td>--%>
                    <td class="col2"><%=i%></td>
                    <td class="col3"><%=employee.getGroupId()%></td>
                    <td class="col4"><%=employee.getEmpName()%></td>
                <td class="col11"><%=employee.getGender()%></td>
                <td class="col9"><%=employee.getEmpId()%></td>
                    <td class="col5"><%=employee.getEmail()%></td>
                    <td class="col10">
    ...
    <div id="addMain">
        <table id="addMessageTable">
            ...
            <tr>
                ...
                <td class="addTableTd2"><input type="text" id="empname1" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="addTableTd1">员工号</td>
                <td class="addTableTd2"><input type="text" id="empId1" /></td>
            </tr>
            <tr>
                <td class="addTableTd1">邮箱</td>
                <td class="addTableTd2"><input type="text" id="email1" /></td>
            </tr>
...
<div id="updateBlock">
    <div id="updateHeader">修改员工信息</div>
    <div id="updateMain">
        <table id="updateMessageTable">
            <tr>
                <td class="updateTableTd1">组号</td>
                <td class="updateTableTd2"><input type="text" id="groupId2"  /></td>
            </tr>
            <tr>
                <td class="updateTableTd1">姓名</td>
                <td class="updateTableTd2"><input type="text" id="empname2" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="updateTableTd1">员工号</td>
                <td class="updateTableTd2"><input type="text" id="empId2" readonly/></td>
            </tr>
            <tr>
                <td class="updateTableTd1">邮箱</td>
                <td class="updateTableTd2"><input type="text" id="email2" /></td>
            </tr>
        </table>
    </div>
...
<div id="examineBlock">
    <div id="examineHeader">查看员工信息</div>
    <div id="examineMain">
        <table id="examineMessageTable">
            ...
            <tr>
                ...
                <td class="examineTableTd2"><input type="text" id="empname3" readonly="readonly" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="examineTableTd1">员工号</td>
                <td class="examineTableTd2"><input type="text" id="empId3" readonly /></td>
            </tr>
            <tr>
                <td class="examineTableTd1">邮箱</td>
                <td class="examineTableTd2"><input type="text" id="email3" readonly="readonly" /></td>
            </tr>
        </table>
    </div>
