...
function examine(obj) {
    ...
    // 将新增框架中的输入框中内容设为当前行对应的内容
    document.getElementById('deptId3').value = iTds[1].innerText;
    document.getElementById('managername3').value = iTds[2].innerText;
    document.getElementById('sex3').value = iTds[3].innerText;
    document.getElementById('managerId3').value = iTds[4].innerText;
    document.getElementById('managerEmail3').value = iTds[5].innerText;
}
