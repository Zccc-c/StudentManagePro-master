...
function update(obj) {
    ...
    document.getElementById('leadername2').value = iTds[2].innerText;
    ...
    document.getElementById('leaderId2').value = iTds[4].innerText;
    document.getElementById('leaderEmail2').value = iTds[5].innerText;
...
function preservation() {
    ...
    var name = document.getElementById('leadername2').value;
    ...
    var insitute = document.getElementById('leaderEmail2').value;
    var data = {};
    data.groupId = id;
    data.leaderName = name;
    data.leaderGender = sexValue;
    data.leaderId = age;
    data.leaderEmail = insitute;
    var protocol = window.location.protocol;
    var host = window.location.host;
    var proName = window.location.pathname.split("/")[1];
    var url = protocol + "//" + host + "/" + proName + "/leaderController/updateLeader";
    if (confirm("确定更新吗？")) {
        $.ajax({
            type : 'post',
            url : url,
