...
function examine(obj) {
    ...
    document.getElementById('empname3').value = iTds[2].innerText;
    document.getElementById('sex3').value = iTds[3].innerText;
    document.getElementById('empId3').value = iTds[4].innerText;
    document.getElementById('email3').value = iTds[5].innerText;
}
