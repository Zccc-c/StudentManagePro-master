...
function jQSubmit() {
    ...
    data.name = document.getElementById('managername1').value;
    data.insitute= document.getElementById('managerEmail1').value;
    data.age = document.getElementById('managerId1').value;
...
function sumbit() {
    ...
    var name = document.getElementById('managername1').value;
    var colg = document.getElementById('managerEmail1').value;
    var age = document.getElementById('managerId1').value;
    var sexSelect = document.getElementById('sex1');
    var sexIndex = sexSelect.selectedIndex;
