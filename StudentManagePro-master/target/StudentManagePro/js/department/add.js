...
function jQSubmit() {
    ...
    var url = protocol + "//" + host + "/" + proName + "/departmentController/addDepartment";
...
function sumbit() {
    ...
    document.getElementById('deptname1').value = null;
    document.getElementById('manager1').value = null;
