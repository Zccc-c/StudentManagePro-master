...
function update(obj) {
    ...
    document.getElementById('empname2').value = iTds[2].innerText;
    ...
    document.getElementById('empId2').value = iTds[4].innerText;
    document.getElementById('email2').value = iTds[5].innerText;
...
function preservation() {
    ...
    var name = document.getElementById('empname2').value;
    ...
    var age = document.getElementById('empId2').value;
    var insitute = document.getElementById('email2').value;
    var data = {};
    data.groupId = id;
    data.empName = name;
    data.gender = sexValue;
    data.empId = age;
    data.email = insitute;
    var protocol = window.location.protocol;
    var host = window.location.host;
    var proName = window.location.pathname.split("/")[1];
    var url = protocol + "//" + host + "/" + proName + "/employeeController/updateEmployee";
    if (confirm("确定更新吗？")) {
        $.ajax({
            type : 'post',
            url : url,
