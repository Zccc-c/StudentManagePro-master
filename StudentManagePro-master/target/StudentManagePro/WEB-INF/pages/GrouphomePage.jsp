...
<%@ page import="pers.kuroko.entity.Group" %>
...
<head>
    ...
    <script src="<%= basePath%>js/group/add.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/group/update.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/group/examine.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/reRange.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/flip.js" type="text/javascript"></script>
    <script src="<%= basePath%>js/group/del.js" type="text/javascript"></script>
...
<%--                <th class="col1"><input type="checkbox" onclick="checkAll(this)"/></th>--%>
                ...
                <th class="col7">部门号</th>
                <th class="col8">管理者号</th>
...
<%--                    <td class="col1"><input type="checkbox" name="item" /></td>--%>
                    <td class="col2"><%=i%></td>
                    <td class="col3"><%=group.getGroupId()%></td>
                <td class="col9"><%=group.getLeaderId()%></td>
                    <td class="col7"><%=group.getDeptId()%></td>
                    <td class="col8"><%=group.getManagerId()%></td>
                    <td class="col10">
...
<div id="updateBlock">
    <div id="updateHeader">修改小组信息</div>
    <div id="updateMain">
...
<div id="examineBlock">
    <div id="examineHeader">查看小组信息</div>
    <div id="examineMain">
